...
<div class="cart content-wrapper">
                    ...
                    <div class="border border">
                        ...
                        <form action="insert.php" method="post">
                            <fieldset class="p-4">
                              <p> Order Details</p>
                              <br>
                              <p>Please Confirm Order Details before purchasing </p>
                              
                              
                              <input type="text" name="item" id="item" placeholder="items*" class="border p-3 w-100 my-2">
                                ...
                                <button type="submit" class="d-block py-3 px-4 bg-primary text-white border-0 rounded font-weight-bold"> Confirm Details </button>
                            </fieldset>
                        </form>
                    </div>
                </div>
  ...
  <script src="https://www.paypal.com/sdk/js?client-id=AWRTjGvwweLjNpmnLknYHdzb0E_RR2cn5HaLe4ilAh4Xq-TBQw1YNjrvz1PH_DH-tN4kKfwgqOS5DIBT&enable-funding=venmo&currency=USD" data-sdk-integration-source="button-factory"></script>
  <script>
